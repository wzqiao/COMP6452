...
NETWORKS = {
    ...
    'testnet': {
        ...
        'rpc_url': 'https://sepolia.drpc.org',  # Sepolia测试网RPC地址
        'chain_id': 11155111,
        'gas_limit': 3000000,
...
# InspectionManager合约ABI（已从Remix获取）
...
# 事件主题哈希（用于过滤事件）
EVENT_SIGNATURES = {
    'BatchCreated': '0x...',      # 可以通过 web3.keccak(text='BatchCreated(...)')计算
