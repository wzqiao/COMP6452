...
contract InspectionManager {
    ...
    uint256 public totalInspections = 0;                                 // Total inspection count
    
    // Associated BatchRegistry contract
    BatchRegistry public batchRegistry;
    
    // Permission control - using BatchRegistry's inspector permission
    ...
    // 🔥 Using BatchRegistry's inspector permission system
    ...
    function updateInspectionResult(
        ...
        // If the inspection is completed, synchronize the batch status
    ...
    function completeInspection(
        ...
        // 🔥 Automatically synchronize batch status
        _syncBatchStatus(inspection.batchId, result);
    ...
    function _syncBatchStatus(uint256 batchId, InspectionResult inspectionResult) internal {
        ...
        // 🔥 Key: Here we need InspectionManager contract itself to have inspector permission
        // First update to INSPECTED
        batchRegistry.updateBatchStatus(batchId, BatchRegistry.BatchStatus.INSPECTED);
        
        // If needed, update to the final status
    ...
    /**
     * @dev Get all inspection records of a batch
     * @param batchId Batch ID
    ...
    /**
     * @dev Get all inspection records of an inspector
    ...
    /**
     * @dev Check if the inspector is authorized (using BatchRegistry's permission)
     * @param inspector Inspector address
    ...
    /**
     * @dev Get the associated BatchRegistry contract address
     * @return BatchRegistry contract address
     */
